...
axis tight;
hold on
plot(Sim.Rad_Output.v_Fahrzeug_ist__m_s__1_.Time,(Sim.Rad_Output.v_Fahrzeug_ist__m_s__1_.Data(:).*3.6))
...
%--------------------------------------------------------------------------
% 
% if exist('Sim.Rad_Output')==1
%    figure
%    plot(Sim.Rad_Output.P_Rad__W_.Time,Sim.Rad_Output.P_Rad__W_.Data(:)/1000);
%    grid on;
%    axis tight;
...
figure
plot(Sim.EMaschine_Verlustleistung_Output.M_EMaschine_ist__Nm_.Time,(2*pi/60/1000.*Sim.Getriebe_Output.n_EMaschine__min__1_.Data.*Sim.EMaschine_Verlustleistung_Output.M_EMaschine_ist__Nm_.Data));
...
figure
plot(Sim.Getriebe_Output.n_EMaschine__min__1_.Time,(2*pi/60/1000.*Sim.Getriebe_Output.n_EMaschine__min__1_.Data(:).*Sim.EMaschine_Verlustleistung_Output.Regelabweichung__Nm_.Data(:)));
grid on;
axis tight;
...
%    figure
%    plot(Sim.Getriebe_Output.n_EMaschine__min__1_.Time,Sim.Getriebe_Output.n_EMaschine__min__1_.Data(:));
%    grid on;
%    axis tight;
...
%    figure
%    plot(Sim.Getriebe_Output.M_EMaschine__Nm_.Time,Sim.Getriebe_Output.M_EMaschine__Nm_.Data(:));
%    grid on;
%    axis tight;
...
figure
plot(Sim.EMaschine_Verlustleistung_Output.P_EMaschine_Verlust_korr__W_.Time,Sim.EMaschine_Verlustleistung_Output.P_EMaschine_Verlust_korr__W_.Data(:)/1000);
hold on
plot(Sim.EMaschine_Thermik_Output.P_EMaschine_Verlust_ist__W_.Time,Sim.EMaschine_Thermik_Output.P_EMaschine_Verlust_ist__W_.Data./1000);
grid on;
axis tight;
...
figure
plot(Sim.EMaschine_Thermik_Output.T_EMaschine_WH__K_.T_EMaschine_WH_1__K_.Time, Sim.EMaschine_Thermik_Output.T_EMaschine_WH__K_.T_EMaschine_WH_1__K_.Data-273.15)
...
figure
plot(Sim.EMaschine_Thermik_Output.T_EMaschine_Kuehlmittel__K_.Time, Sim.EMaschine_Thermik_Output.T_EMaschine_Kuehlmittel__K_.Data-273.15)
% Vergleich mit Messdaten, falls Messfahrt simuliert wurde
