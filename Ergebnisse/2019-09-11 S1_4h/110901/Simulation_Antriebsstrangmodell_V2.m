...
T_Umgebung=273.15 + 20;                    % Umgebungstemperatur in K 
T_Start_EMaschine = 273.15 + 20;           % Starttemperatur E-Maschine in K
T_Start_Coolant = 273.15 + 20;             % Starttemperatur Kühlmittel in K
%n_EM = 5000;                               % min^-1
%M_EM = 45;                                 % Nm
